...
/// SompiPerRustweave is the number of sompi in one kaspa (1 RWE).
pub const SOMPI_PER_RUSTWEAVE: u64 = 100_000_000;

/// The parameter for scaling inverse RWE value to mass units (KIP-0009)
pub const STORAGE_MASS_PARAMETER: u64 = SOMPI_PER_RUSTWEAVE * 10_000;

/// MaxSompi is the maximum transaction amount allowed in sompi.
pub const MAX_SOMPI: u64 = 29_000_000_000 * SOMPI_PER_RUSTWEAVE;
