...
pub enum RpcApiOps {
    ...
    GetSyncStatus,
    /// Returns the network this Rustweaved is connected to (Mainnet, Testnet)
    GetCurrentNetwork,
    ...
    GetBlockTemplate,
    /// Returns a list of all the addresses (IP, port) this Rustweaved knows and a list of all addresses that are currently banned by this Rustweaved
    GetPeerAddresses,
    ...
    GetMempoolEntries,
    /// Returns a list of the peers currently connected to this Rustweaved, along with some statistics on them
    GetConnectedPeerInfo,
    /// Instructs Rustweaved to connect to a given IP address.
    AddPeer,
