use crate::{
    error::{Error, Result},
    resolver::{RustweavedResponseReceiver, RustweavedResponseSender, Resolver},
};
...
impl Pending {
    fn new(sender: RustweavedResponseSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: RustweavedPayloadOps, request: &RustweavedRequest) -> RustweavedResponseReceiver {
