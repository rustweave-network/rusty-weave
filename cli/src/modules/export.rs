...
async fn export_multisig_account(ctx: Arc<RustweaveCli>, account: Arc<MultiSig>) -> Result<()> {
...
async fn export_single_key_account(ctx: Arc<RustweaveCli>, account: Arc<dyn Account>) -> Result<()> {
