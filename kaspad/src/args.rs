    ...
    let cmd = Command::new("kaspad")
        ...
        .arg(
            Arg::new("rpclisten")
                ...
                .help("Interface:port to listen for gRPC connections (default port: 11110, testnet: 16210)."),
        )
        .arg(
        ...
        .arg(
            Arg::new("listen")
                ...
                .require_equals(true)
                .value_parser(clap::value_parser!(ContextualNetAddress))
                .help("Add an interface:port to listen for connections (default all interfaces port: 11111, testnet: 16211)."),
        )
        .arg(
            Arg::new("outpeers")
                .long("outpeers")
...
/*
  ...
  -a, --addpeer=                            Add a peer to connect with at startup
      ...
      --whitelist=                          Add an IP network or IP that will not be banned. (eg. 192.168.1.0/24 or
                                            ::1)
      --rpclisten=                          Add an interface/port to listen for RPC connections (default port: 11110,
                                            testnet: 16210)
