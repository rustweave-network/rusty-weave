                                ...
                                .import_legacy_keydata(
                                    ...
                                    Some(Arc::new(move |processed: usize, _, balance, txid| {
                                        if let Some(txid) = txid {
                                            tprintln!(
                                                ctx_,
                                                "Scan detected {} RWE at index {}; transfer txid: {}",
            ...
            .derivation_scan(
                ...
                Some(Arc::new(move |processed: usize, _, balance, txid| {
                    if let Some(txid) = txid {
                        ...
                        tprintln!(ctx_, "Scanned {} derivations, found {} RWE", processed, sompi_to_kaspa_string(balance));
                    }
                })),
            )
            .await?;
