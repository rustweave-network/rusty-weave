...
use super::{
    ...
    interface::{Interface, RustweavedMethod, RustweavedRoutingPolicy},
    method::Method,
};
use crate::{
...
use kaspa_grpc_core::protowire::{rustweaved_request::Payload, *};
use kaspa_grpc_core::{ops::RustweavedPayloadOps, protowire::NotifyFinalityConflictResponseMessage};
...
impl Factory {
    ...
    pub fn new_interface(server_ctx: ServerContext, network_bps: u64) -> Interface {
        ...
        let method: RustweavedMethod = Method::new(|server_ctx: ServerContext, connection: Connection, request: RustweavedRequest| {
            Box::pin(async move {
                let mut response: RustweavedResponse = match request.payload {
        ...
        interface.replace_method(RustweavedPayloadOps::NotifyFinalityConflict, method);
        ...
        interface.set_method_properties(
            ...
            RustweavedRoutingPolicy::DropIfFull(Arc::new(Box::new(|_: &RustweavedRequest| {
